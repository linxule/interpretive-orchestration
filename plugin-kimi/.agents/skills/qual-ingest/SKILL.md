...
Batch process interview recordings and documents.

```bash
python .agents/skills/qual-ingest/scripts/process_documents.py \
...
- **Skills:** qual-convert for detailed PDF handling
